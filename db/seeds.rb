...
CSV.foreach(csv_file_path, headers: true, header_converters: :symbol) do |row|
  Profile.create!(favorite_shirt_number: row[:numero_de_camisa_preferido], shoe_size: row[:tamanho_do_sapato],
    ...
    preferred_communication_channel: row[:canal_de_comunicacao_preferido])
end
